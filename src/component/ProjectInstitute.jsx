...
const ProjectInstitute = () => {
  let {data,isLoading,isError,isFetching,isFetched,refetch} = useQuery('projectInstitute',()=>getProjectType('institute'))
  let content; 
...
export default ProjectInstitute